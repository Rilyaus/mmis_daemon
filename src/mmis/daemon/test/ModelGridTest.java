...
public class ModelGridTest {
	...
	public static void main(String[] args) {
		...
		ModelGridUtil modelGridUtil = new ModelGridUtil(ModelGridUtil.Model.KIM_GWW3, ModelGridUtil.Position.MIDDLE_CENTER, 
				"F:/data/mmis_sample/meta/kim_gww3_lat.bin", "F:/data/mmis_sample/meta/kim_gww3_lon.bin");
