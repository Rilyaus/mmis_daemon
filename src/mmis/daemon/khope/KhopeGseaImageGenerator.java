...
public class KhopeGseaImageGenerator extends KhopeFileGenerator {
	
	private final int imageExpandFactor = 50;
	private final int imageResizeFactor = 1;
	
	public KhopeGseaImageGenerator(final String metaDirPath) {	
			...
			for(Object[] variableInfo : variableInfos) {
				...
				for(int t=0 ; t<timeLength ; t++) {
					...
					for(int d=0 ; d<depLength ; d++) {
					    ...
					    String imgFileName = "KHOPE_GSEA_" + issuedTmStr + "_" +  variableInfo[1] + "_" + String.format("%02d", t+1) + "_" + String.format("%02d", d+1) + ".png";
