...
public class KimCww3ImageGenerator extends KimFileGenerator {
	
	private final int imageExpandFactor = 100;
	private final int imageResizeFactor = 1;
	
	public KimCww3ImageGenerator(final String metaDirPath) {	
		
		this.setKimMetaFiles(metaDirPath, KimFileGenerator.KIM_MODEL.KIM_CWW3);
	...
	public boolean initCoordinates() {
		...
		this.modelGridUtil = new ModelGridUtil(ModelGridUtil.Model.KIM_CWW3, ModelGridUtil.Position.TOP_LEFT, this.kimLatFilePath, this.kimLonFilePath);
	...
	public List<Map<String, Object>> generateFile(final String srcFilePath, final String destFilePath) {
		...
		final Object[][] variableInfos = new Object[][]{
			{"Peak_wave_period_surface", "WP", KimLegend.Legend.CWW3_WP, 25, null},
			{"Significant_height_of_wind_waves_surface", "SIG_WH", KimLegend.Legend.CWW3_SIG_WH, 25, null}
		};
		...
		try {
			...
			for(Object[] variableInfo : variableInfos) {
				...
				for(int t=0 ; t<timeLength ; t++) {
				    ...
				    String imgFileName = "KIM_CWW3_" + issuedTmStr + "_" +  variableInfo[1] + "_" + String.format("%02d", t+1) + ".png";
