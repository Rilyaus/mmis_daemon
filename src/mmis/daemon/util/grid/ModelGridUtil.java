...
public class ModelGridUtil {
	...
	public enum Model {
		...
		KHOPE_GDPS,
		KHOPE_GLOSEA5_DAY,
		KHOPE_GLOSEA5_DAY_REGRID,
		KHOPE_GLOSEA5_DAY_NEW,
		KHOPE_GLOSEA5_DAY_NEW_REGRID,
		KHOPE_GLOSEA5_SUN,
		KHOPE_GLOSEA5_SUN_REGRID,
		KHOPE_HYDR,
		KHOPE_HYCOM,
		KIM_CWW3,
		KIM_RWW3,
	...
	public ModelGridUtil(Model model, Position position, String latPath, String lonPath) {
		...
		if(Model.DFS.equals(model)) {
			
			this.modelWidth = 149;
			this.modelHeight = 253;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.DFS_REGRID.equals(model)) {
			
			this.modelWidth = 149;
			this.modelHeight = 253;
			
			this.defaultLatInterval = 0.04691239765712193;
			this.defaultLonInterval = 0.06440822498218433;
			
			this.byteOrder = ByteOrder.BIG_ENDIAN;	
			
		} else if(Model.KHOPE_GSEA.equals(model)) {
			
			this.modelWidth = 131;
			this.modelHeight = 141;
			
			this.defaultLatInterval = 0.25;
			this.defaultLonInterval = 0.25;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_LDPS.equals(model)) {
			
			this.modelWidth = 602;
			this.modelHeight = 781;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_LDPS_REGRID.equals(model)) {
			
			this.modelWidth = 602;
			this.modelHeight = 781;
			
			this.defaultLatInterval = 0.0140276391616041;
			this.defaultLonInterval = 0.01908748644324021;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_GDPS.equals(model)) {
			
			this.modelWidth = 306;
			this.modelHeight = 427;
			
			this.defaultLatInterval = 0.09375;
			this.defaultLonInterval = 0.140625;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
		} else if(Model.KHOPE_GLOSEA5_DAY.equals(model)) {
			
			this.modelWidth = 281;
			this.modelHeight = 261;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_GLOSEA5_DAY_REGRID.equals(model)) {
			
			this.modelWidth = 281;
			this.modelHeight = 261;
			
			this.defaultLatInterval = 0.19750224993779142;
			this.defaultLonInterval = 0.273496110098705;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_GLOSEA5_DAY_NEW.equals(model)) {
		...
		} else if(Model.KHOPE_GLOSEA5_DAY_NEW_REGRID.equals(model)) {
			
			this.modelWidth = 213;
			this.modelHeight = 196;
			
			this.defaultLatInterval = 0.20280417417868613;
			this.defaultLonInterval = 0.260077242581346;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_GLOSEA5_SUN.equals(model)) {
		...
		} else if(Model.KHOPE_GLOSEA5_SUN_REGRID.equals(model)) {
		...
		} else if(Model.KHOPE_HYDR.equals(model)) {
			
			this.modelWidth = 366;
			this.modelHeight = 345;
			
			this.defaultLatInterval = 0.027777;
			this.defaultLonInterval = 0.027777;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KHOPE_HYCOM.equals(model)) {
			
			this.modelWidth = 551;
			this.modelHeight = 1052;
			
			this.defaultLatInterval = 0.039999;
			this.defaultLonInterval = 0.079956;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KIM_CWW3.equals(model)) {
			
			this.modelWidth = 1201;
			this.modelHeight = 1501;
		...
		} else if(Model.KIM_GWW3.equals(model)) {
			
			this.modelWidth = 720;
			this.modelHeight = 281;
			
			this.defaultLatInterval = 0.5;
			this.defaultLonInterval = 0.5;
		...
		} else if(Model.KIM_CTSM.equals(model)) {
		...
		} else if(Model.KIM_RTSM.equals(model)) {
			
			this.modelWidth = 421;
			this.modelHeight = 385;
			
			this.defaultLatInterval = 0.08333;
			this.defaultLonInterval = 0.08333;
	
			this.byteOrder = ByteOrder.BIG_ENDIAN;
			
		} else if(Model.KIM_RTSM_RESTART.equals(model)) {
			
			this.modelWidth = 211;
			this.modelHeight = 193;
		...
		} else if(Model.THCP.equals(model)) {
			
			this.modelWidth = 301;
			this.modelHeight = 161;
