package mmis.daemon.util.marchingsquare;

import static mmis.daemon.util.marchingsquare.Cell.Side.BOTTOM;
import static mmis.daemon.util.marchingsquare.Cell.Side.LEFT;
import static mmis.daemon.util.marchingsquare.Cell.Side.NONE;
import static mmis.daemon.util.marchingsquare.Cell.Side.RIGHT;
import static mmis.daemon.util.marchingsquare.Cell.Side.TOP;

import java.awt.geom.GeneralPath;

import mmis.daemon.util.marchingsquare.Cell.Side;
